...
const ContextSuggestions = ({ suggestions, onSelectSuggestion, currentContext, isCollapsed }) => {
    ...
    return (
      <div className="space-y-4">
        <div className="group relative">
          ...
          {/* Tooltip */}
          <div className="absolute right-full mr-2 px-3 py-2 bg-popover text-popover-foreground text-sm rounded-lg shadow-elevation-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 whitespace-nowrap z-50">
            Context Suggestions
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Current Context */}
      {currentContext && (
        <div className="glass-morphic rounded-lg p-4 border border-glass-border">
          ...
          <p className="text-sm text-muted-foreground">{currentContext}</p>
        </div>
      )}
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Icon name="ArrowUpRight" size={12} className="text-muted-foreground group-hover:text-primary transition-colors duration-200" />
                    </div>
                  </div>
                </button>
              ))}
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            className="glass-morphic glass-hover border-glass-border hover:border-primary/30 text-xs"
          >
